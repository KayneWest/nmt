...
def prototype_encdec_state():
    ...
    state['target'] = [baseDir + 'target-en-fr-binarized_text.h5']
    state['source'] = [baseDir + 'source-en-en-binarized_text.h5']
    state['indx_word'] = baseDir + 'source-en-en-invert-dict.pkl'
    state['indx_word_target'] = baseDir + 'target-en-fr-invert-dict.pkl'
    state['word_indx'] = baseDir + 'source-en-en-vocab.pkl'
    state['word_indx_trgt'] = baseDir + 'target-en-fr-vocab.pkl'
